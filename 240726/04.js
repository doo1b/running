...
var newNum = numbers.filter(e => e > 15);
// 출력값 [20, 25]
...
console.log("4.", arr.filter(e => e.length > 4));
 
 
5.
var arr = ["banana", "kiwi", "mango", "strawberry", "lime", "orange", "plum", "cherry"];
// 요소의 문자열 길이가 홀수인 요소만 반환하여 출력해주세요
console.log("5.", arr.filter(e => e.length % 2 !== 0));
...
console.log("11.", arr.some(e => e < 0));

12.
var arr = [1, 5, -3, 10, 0, 8];
// 모든 숫자가 음수인지 판별하는 코드를 작성하고 반환값을 출력해주세요
console.log("12.", arr.every(e => e < 0));
